"""Utility to create lightweight subsets from the HFAF anime dataset."""
...
def build_subsets(
    ...
    """Create a smaller subset of HFAF anime images.

    Args:
        source_root (str): Original HFAF anime directory.
        small_root (str): Output directory for the subset.
        small_ratio (float): Fraction to include in the subset.
